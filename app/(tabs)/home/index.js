  ...
  return (
    <ScrollView>
      <View style={{ padding: 12, height: 200, backgroundColor: "#FEBE10" }}>
        ...
        >
          <View style={{padding:0, marginLeft:0, marginHorizontal:0}}>
            <Image
              style={{ marginLeft:0,width: 200, height: 50, resizeMode: "cover" }}
        ...
        <View>
          ...
          >
            <View>
              ...
              <Text style={{ marginTop: 4 }}>Now</Text>
            </View>
            <Entypo name="triangle-right" size={18} color="#034694" />
          </View>
        </View>
